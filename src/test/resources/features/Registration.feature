Feature: User Registration and Account Management
  ...
  Scenario: Register a new user, log in, and delete the account
    ...
    And I enters the name "Neel"
    And I enters email "raj1234@gmail.com"
    ...
    And I fills My personal details firstname "Atul", lastname "Patel", company "B And B Bearing", address "33, Harrow", addressTwo "Harrow Road", country "India", state "Gujarat", city "Surat", zipcode "50001", mobileNumber "6645295673"
    And I clicks the Create Account button
    Then I verifies that ACCOUNT CREATED! is visible
    And I clicks the Continue button
    And I verifies that Logged in as username "Neel" is visible
